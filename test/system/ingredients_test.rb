...
class IngredientsTest < ApplicationSystemTestCase
  ...
  test "creating a Ingredient" do
    ...
    fill_in "Ingredients name", with: @ingredient.ingredients_name
    fill_in "Ingredients quantity", with: @ingredient.ingredients_quantity
    fill_in "Ingredients unit", with: @ingredient.ingredients_unit
